...
urlpatterns = [
    ...
    url(r'^studen/filter/$', TemplateView.as_view(template_name='register/cirstaff/filter_external.html'),name="filter_external"),
    url(r'^studen/filter/external/$', StudentFilterExternalView.as_view(),name="filter_external_list"),
]